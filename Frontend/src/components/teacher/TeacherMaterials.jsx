...
const TeacherMaterials = ({
  ...
  const getFileSize = (url) => {
    // This would be implemented with actual file size data from backend
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Upload and manage course materials for your students</p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              disabled={!uploadForm.courseId || !uploadForm.title || !uploadForm.file || isUploading}
      ...
      <div>
        ...
        {materials.length === 0 ? (
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-gray-600 mb-2">No materials uploaded</h3>
            ...
            <div className="flex justify-center">
              <div className="bg-gradient-to-r from-blue-100 to-purple-100 px-4 py-2 rounded-lg">
                <p className="text-sm text-blue-800 font-medium">💡 Tip: Use the upload form above</p>
              </div>
            </div>
          </motion.div>
        ) : (
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h4 className="text-xl font-bold text-gray-800">{m.title}</h4>
                      </div>
                      
                      <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600">
                        <div className="flex items-center gap-1">
                          <FaBook className="text-blue-500" />
                          <span>{m.course?.title || m.course?.course?.title || "Unknown Course"}</span>
                        </div>
                        
                        <div className="flex items-center gap-1">
                          <FaClock className="text-gray-500" />
                          <span>
                            Uploaded on {formatDate(m.createdAt)}
                          </span>
                        </div>
